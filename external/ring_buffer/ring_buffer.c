...
/***************************************************************************************************
 * @brief Insert multiple items into Ring Buffer
 ***************************************************************************************************/
int RingBuffer_InsertMult(RINGBUFF_T *RingBuff, const void *data, int num)
{
    ...
    /* We cannot insert when queue is full */
    if (RingBuffer_IsFull(RingBuff) || num < 0)
        return 0;
...
/***************************************************************************************************
 * @brief Pop single item from Ring Buffer
 ***************************************************************************************************/
...
/***************************************************************************************************
 * @brief Pop multiple items from Ring buffer
 ***************************************************************************************************/
int RingBuffer_PopMult(RINGBUFF_T *RingBuff, void *data, int num)
{
    ...
    if (RingBuffer_IsEmpty(RingBuff) || num < 0)
        return 0;

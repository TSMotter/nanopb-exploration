...
// Se for utilizar sempre potencia de 2 para o tamanho dos buffer, utilizar este
#define RB_INDH(rb) ((rb)->head & ((rb)->count - 1))
#define RB_INDT(rb) ((rb)->tail & ((rb)->count - 1))

// senao, utilizar estes para qualquer tamanho de buffer, porem, operacoes mais lentas
